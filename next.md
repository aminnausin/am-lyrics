...
1. **Add 'use client' directive if you haven't already**
2. Dynamically import the web component
...
const AmLyrics = dynamic(
  () => {
    ...
    import('@aminnausin/am-lyrics/am-lyrics.js');
    // Then import the React component
    return import('@aminnausin/am-lyrics/react').then((mod) => mod.AmLyrics);
  },
  { ssr: false }
);
```

1. Profit (follow the README's React guide from here)
